...
export default function Goals() {
  return (
    <section id="goals" className="py-12 px-6 shadow-inner bg-gray-50 dark:bg-gray-900 transition-colors duration-300">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <ul className="space-y-6 text-sm text-gray-700 dark:text-gray-300">
          ...
          <li className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-all">
            ಮುಂದಿನ ಗುರಿ: ಕುಮಟಾದಲ್ಲಿ ಕನ್ನಡ ಎಂ.ಎ. ಪದವಿ ಅಧ್ಯಯನ. 🎓
          </li>
          <li className="bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-all">
            ಕನ್ನಡ ಭಾಷೆಗೆ ಸೇವೆ ಸಲ್ಲಿಸುವ, ಅಕ್ಷರಗಳ ಲೋಕದಲ್ಲಿ ವಿಹರಿಸುವ ಹೆಬ್ಬಯಕೆ. ✨
          </li>
        </ul>
      </div>
    </section>
